...
public abstract class FontManager
{
     ...
     * of character arrays. e.g. U+0020-U+007F,U+2034
     * 
     * @param r String representation of unicode character ranges
     * @return char[][] Array of an array of characters in the specified ranges.
    ...
    private static void parseRanges(StringTokenizer st, int[][] ranges)
    {
        ...
        while (st.hasMoreElements())
        {
            ...
            if (element.startsWith("U+"))
            {
                ...
                else if (range.indexOf('-') > 0) // Basic Range, e.g.
                // U+0020-U+007E
                {
