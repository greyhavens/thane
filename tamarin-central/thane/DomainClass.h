...
#ifndef __thane_DomainClass__
#define __thane_DomainClass__
...
namespace avmthane
{
	...
	public:		
        ...
        bool isAssignableAs (ClassClosure *asClass, Atom a);
        bool isDynamic (Atom a);
