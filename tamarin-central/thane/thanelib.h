...
const uint32_t avmplus_Domain_private_initNewDomain = 54;
const uint32_t avmplus_Domain_private_doLoadBytes = 56;
const uint32_t avmplus_Domain_getClass = 57;
const uint32_t avmplus_Domain_getVariables = 58;
const uint32_t avmplus_Domain_getClassName = 59;
const uint32_t avmplus_Domain_isAssignableAs = 60;
const uint32_t avmplus_Domain_isDynamic = 61;
const uint32_t avmplus_Domain_domainMemory_get = 62;
const uint32_t avmplus_Domain_domainMemory_set = 63;
const uint32_t flash_utils_Dictionary_private_init = 360;
const uint32_t avmplus_System_private_doExit = 590;
const uint32_t avmplus_System_private_doResetTimeout = 592;
const uint32_t avmplus_System_getAvmplusVersion = 593;
const uint32_t avmplus_System_trace = 594;
const uint32_t avmplus_System_getTimer = 595;
const uint32_t avmplus_System_private_getArgv = 596;
const uint32_t flash_utils_ByteArray_readBytes = 673;
const uint32_t flash_utils_ByteArray_writeBytes = 674;
const uint32_t flash_utils_ByteArray_writeBoolean = 675;
const uint32_t flash_utils_ByteArray_writeByte = 676;
const uint32_t flash_utils_ByteArray_writeShort = 677;
const uint32_t flash_utils_ByteArray_writeInt = 678;
const uint32_t flash_utils_ByteArray_writeUnsignedInt = 679;
const uint32_t flash_utils_ByteArray_writeFloat = 680;
const uint32_t flash_utils_ByteArray_writeDouble = 681;
const uint32_t flash_utils_ByteArray_writeUTF = 682;
const uint32_t flash_utils_ByteArray_writeUTFBytes = 683;
const uint32_t flash_utils_ByteArray_readBoolean = 684;
const uint32_t flash_utils_ByteArray_readByte = 685;
const uint32_t flash_utils_ByteArray_readUnsignedByte = 686;
const uint32_t flash_utils_ByteArray_readShort = 687;
const uint32_t flash_utils_ByteArray_readUnsignedShort = 688;
const uint32_t flash_utils_ByteArray_readInt = 689;
const uint32_t flash_utils_ByteArray_readUnsignedInt = 690;
const uint32_t flash_utils_ByteArray_readFloat = 691;
const uint32_t flash_utils_ByteArray_readDouble = 692;
const uint32_t flash_utils_ByteArray_readUTF = 693;
const uint32_t flash_utils_ByteArray_readUTFBytes = 694;
const uint32_t flash_utils_ByteArray_length_get = 695;
const uint32_t flash_utils_ByteArray_length_set = 696;
const uint32_t flash_utils_ByteArray_private_zlib_compress = 697;
const uint32_t flash_utils_ByteArray_private_zlib_uncompress = 699;
const uint32_t flash_utils_ByteArray_private__toString = 701;
const uint32_t flash_utils_ByteArray_bytesAvailable_get = 703;
const uint32_t flash_utils_ByteArray_position_get = 704;
const uint32_t flash_utils_ByteArray_position_set = 705;
const uint32_t flash_utils_ByteArray_endian_get = 706;
const uint32_t flash_utils_ByteArray_endian_set = 707;
const uint32_t flash_net_Socket_private_nb_disconnect = 759;
const uint32_t flash_net_Socket_private_nb_connect = 760;
const uint32_t flash_net_Socket_private_nb_read = 761;
const uint32_t flash_net_Socket_private_nb_write = 762;
...
#define avmplus_System_private_doResetTimeout_thunk  thanelib_v2a_o_thunk
