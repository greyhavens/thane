...
print("ASC="+classpath)
print("Building thanelib...")

# compile builtins
os.system(asc+" -abcfuture -import ../core/builtin.abc -builtin -outdir . -out thanelib `find as3src -name \*.as`")

print("Generating native thunks...")
os.system("python ../utils/nativegen.py ../core/builtin.abc thanelib.abc")

mv("thanelib.cpp2", "thanelib.cpp")
mv("thanelib.h2", "thanelib.h")
